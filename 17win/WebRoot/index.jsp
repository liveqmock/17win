								...
								<FORM name="form" method="post" action=login.asp
									...
									<TABLE class=LeftNews cellSpacing=0 cellPadding=0 width="100%"
										...
										<TR>
											...
											<TD>
												<INPUT id=name style="MARGIN-TOP: 5px" tabIndex=1
													maxLength=28 size=19 name=name>
											</TD>
										</TR>
										<TR>
											<TD>
											...
											<TD>
												<input id=pass style="MARGIN-TOP: 5px" tabindex=2
													type=password size=20 name=pass>
											</TD>
										</TR>
										<TR>
											<TD>
											...
											<TD>
												<input type="text" maxLength="4" tabindex=3
													style="width: 35px;" name="CheckCode">
												...
												<TD align=left width=346>
													<TABLE style="BACKGROUND: url(Images/Top_30.gif) repeat-y"
														...
														<TBODY>
																			...
																			<TR>
																				<TD width="65%" height=30>
																					<table class=LeftNews cellSpacing=0 cellPadding=0
																						...
																						<tr>
																							<td>
																								<a href='../news.asp?/1445.html' target="_blank"
																									title='免费刷钻-公务员兼职淘宝三年买房买车'><font color=>免费刷钻-公务员兼职淘宝三年买</font>
																								</a>
																							</td>
																						</tr>
																						<tr>
																							<td>
																								<a href='../news.asp?/1444.html' target="_blank"
																						...
																						<tr>
																							<td>
																								<a href='../news.asp?/1443.html' target="_blank"
																									title='淘宝刷钻-如何处理顾客砍价问题？'><font color=>淘宝刷钻-如何处理顾客砍价问题</font>
																								</a>
																							</td>
																						</tr>
																					</table>
															...
															<TR>
																<TD style="BACKGROUND: url(Images/Top_31.gif) no-repeat"
																	height=7></TD>
															</TR>
														</TBODY>
													</TABLE>
																						...
																						<tr>
																							<td>
																								<a href='../news.asp?/1432.html' target="_blank"
																									title='免费刷钻-买家必读'><font color=>免费刷钻-买家必读</font>
																								</a>
																							</td>
																						</tr>
																						<tr>
																							<td>
																								<a href='../news.asp?/1431.html' target="_blank"
																									title='刷钻平台-淘宝买家也要讲评价的诚信'><font color=>刷钻平台-淘宝买家也要讲评价的</font>
																								</a>
																							</td>
																						</tr>
																					</table>
