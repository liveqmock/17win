...
<DIV style="CLEAR: both; MARGIN-TOP: 2px; WIDTH: 910px; HEIGHT: 25px">
	<DIV style="FLOAT: left; OVERFLOW: hidden; WIDTH: 800px">
		<UL id="task_nav<s:property value="#request.platformType"/>">
			<LI>
				<A
					<s:if test="#request.showTaskType==1">
					style="FONT-SIZE: 16px; BACKGROUND: url(images/task_nav<s:property value="#request.platformType"/>.gif) no-repeat 50% bottom; COLOR: #ffffff"
					</s:if>
...
<DIV style="CLEAR: both; WIDTH: 910px">
	<IMG src="images/task_line<s:property value="#request.platformType"/>.gif">
</DIV>