...
INSERT INTO `tb_property` VALUES ('13', 'buyReleaseDotRebateToRefree', '0.1', null, '当购买发布点的时候，推广人所得金额为，他推荐人买的发布点的金额的0.1');
...
INSERT INTO `tb_property` VALUES ('17', 'refreeByVipMoney', '5', null, '通过你的宣传链接注册的会员购买VIP，获得5元');
INSERT INTO `tb_property` VALUES ('18', 'task100RefreeMoney', '10', null, '积累接受100个任务 推广人获取10元钱');
INSERT INTO `tb_property` VALUES ('19', 'score1000Refree', '100', null, '通过你的宣传链接注册的会员积分每上升1000 ，你的收益=100积分');
